      ...
      <div class="container container--cart">
          <div class="cart">
            <div class="cart__top">
              ...
              <div onClick={clearPizzasHundler} class="cart__clear">
            ...
            <div class="content__items">
                {items.map((item) => (
                    <CartItem key={item.id} id = {item.id} title={item.title} imgUrl={item.imageUrl} price={item.price} count={item.count} type={item.type} size={item.size}/>
                ))}
            ...
            <div class="cart__bottom">
              <div class="cart__bottom-details">
                ...
                <span> Order amount: <b>{total} $</b> </span>
              </div>
